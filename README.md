...
The CLI streams progress as each source and pipeline stage completes, then writes the finished run to `outputs/`, the same as the web interface.
...
Then open `http://127.0.0.1:8000` in your browser. Click **New search**, enter a topic, and optionally check **Refine query** to have a small local model tighten your query's phrasing before searching.
